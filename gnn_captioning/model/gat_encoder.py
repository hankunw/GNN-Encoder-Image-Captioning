...
from gnn_captioning.config import NUM_PATCHES_GAT, ENCODE_DIM_GAT, HIDDEN_DIM_GAT, SIN_PE_GAT, GAT_LAYER

class GAT_Encoder(nn.Module):
    def __init__(self,
                 img_size=224,
                 num_patches = NUM_PATCHES_GAT,
                 in_channels=3,
                 encode_dim=ENCODE_DIM_GAT,
                 use_sin_pe=SIN_PE_GAT,
                 gat_layers=GAT_LAYER,
